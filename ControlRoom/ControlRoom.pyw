...
def main():
    ...
    headerframe= Frame(window, relief= 'sunken', bg= 'lightgreen')
    headerframe.grid(row=1, columnspan=2, sticky='ew')
    headerframe.grid_rowconfigure(0, weight=2)
    headerframe.grid_columnconfigure(0, weight=2)

    frame= Frame(window, relief= 'sunken', bg= 'lightgreen')
    frame.grid(row=1, columnspan=2, sticky='ew')
    frame.grid_rowconfigure(0, weight=2)
    frame.grid_columnconfigure(0, weight=2)

    fsep= Frame(window, relief= 'sunken', bg= 'lightgreen')
    fsep.grid(row=1, columnspan=2, sticky='ew')
    fsep.grid_rowconfigure(0, weight=2)
    fsep.grid_columnconfigure(0, weight=2)

    headerframe1= Frame(window, relief= 'sunken', bg= 'lightgreen')
    headerframe1.grid(row=1, columnspan=2, sticky='ew')
    headerframe1.grid_rowconfigure(0, weight=2)
    headerframe1.grid_columnconfigure(0, weight=2)

    frame1= Frame(window, relief= 'sunken', bg= 'lightgreen')
    frame1.grid(row=1, columnspan=2, sticky='ew')
    frame1.grid_rowconfigure(0, weight=2)
    frame1.grid_columnconfigure(0, weight=2)

    browseframe= Frame(window, relief= 'sunken', bg= 'lightgreen')
    browseframe.grid(row=1, columnspan=2, sticky='ew')
    browseframe.grid_rowconfigure(0, weight=2)
    browseframe.grid_columnconfigure(0, weight=2)

    ssep= Frame(window, relief= 'sunken', bg= 'lightgreen')
    ssep.grid(row=1, columnspan=2, sticky='ew')
    ssep.grid_rowconfigure(0, weight=2)
    ssep.grid_columnconfigure(0, weight=2)

    advancedframe= Frame(window, relief= 'sunken', bg= 'lightgreen')
    advancedframe.grid(row=1, columnspan=2, sticky='ew')
